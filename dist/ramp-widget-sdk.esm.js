...
var NashRamp = /** @class */ (function () {
    function NashRamp(init) {
        ...
        this.env = (_a = init.env) !== null && _a !== void 0 ? _a : "PRODUCTION";
        this.destination = init.destination;
        this.base = init.base;
        this.target = init.target;
    }
    NashRamp.prototype.getIframeUrl = function (options) {
        return envs[this.env] + "?fromSdk=true&fiatSymbol=" + options.base + "&cryptoSymbol=" + options.target + "&destination=" + options.destination + (options.referrer != null ? "&referrer=" + options.referrer : "") + (options.redirect != null ? "&redirect=" + encodeURI(options.redirect) : "");
    };
    /**
